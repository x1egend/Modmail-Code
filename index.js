...
client.on("ready", () => {
  ...
  client.user.setActivity("$ is the prefix | Dm me to contact the staff!")
...
client.on("channelDelete", (channel) => {
  ...
  if (channel.parentID == channel.guild.channels.cache.find((x) => x.name == "MODMAIL").id) {
    ...
    let yembed = new discord.MessageEmbed()
      ...
      .setDescription("This thread will close soon. If you have any more questions please do not hesitate to contact us again. Just dm the modmail in the bot's dm's for further support.Your mail was deleted by a staff member!")
  ...
  if (message.guild) {
    ...
    if (command == "mod-mail") {
      ...
      let nembed = new discord.MessageEmbed()
        ...
        .addField("Direct Contact", "** wants to contact to us!proper staff should assist him according to his/her problem.");
      ...
      let embed = new discord.MessageEmbed()
        ...
        .addField("$Mod-Mail", "Setup the modmail system(This is not for multiple server.)", true)
  ...
  if (!message.guild) {
    ...
    if (!main) {
      ...
      let sembed = new discord.MessageEmbed()
        ...
        .setDescription("Hello, thank you for contacting the ModMail support. Please type in your problem so that the right staff can assist you! ")
